    ...
    <div class="flex justify-between h-16 items-center">
      ...
      <div class="hidden md:flex items-center space-x-1">
        ...
        <div class="relative">
          ...
          {{-- IF uslugi -> NOT clickable --}}
          @if ($nav->slug === 'uslugi')
          <span
            class="flex items-center text-taupe-900 hover:text-zinc-900 px-3 py-2 font-normal cursor-pointer desktop-dropdown-toggle">
            {{ $nav->name }}
            ...
            <ul class="py-2">
              ...
              <li>
                <a href="{{ url($nav->slug . '/' . $sub->slug) }}"
                  class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-zinc-850 text-sm transition-colors duration-200">
                  {{ $sub->sub_name }}
                </a>
              </li>
              @endforeach
      ...
      <div class="md:hidden flex items-center">
        <button id="mobile-menu-button" class="text-gray-700 hover:text-zinc-850 focus:outline-none">
