...
<div class="container-fluid py-2">
  <div class="row">
    <div class="ms-3">
      ...
      <p class="mb-4">
        Building main navigation for the admin panel is easy with our navigation builder. You can add, edit, and delete
        navigation items, and they will be reflected in the sidebar automatically.
      </p>
    </div>
  </div>
  @if ($errors->any())
